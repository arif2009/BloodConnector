  ...
  return (
    <View style={mbSm}>
      <Item error={touched && !!error} rounded>
        ...
        <Input
          secureTpickerStyleextEntry={JSON.parse(secureTextEntry)}
    ...
    <View>
      <View
        style={[
          pickerStyle,
          mbSm,
          {borderColor: touched && !!error ? '#DD5144' : '#d6d7da'},
        ]}>
        <Grid>
          <Col size={10} style={drpIconLeft}>
            <Icon
              style={{color: touched && !!error ? '#DD5144' : '#000'}}
              type={iconType}
              name={iconName}
            />
          </Col>
          ...
          {touched && !!error && (
            <Col size={10} style={drpIconRight}>
    ...
    return (
      <View
        ...
        <Field
          ...
          placeholder="FirstName LastName NikeName"
        ...
        <Field
          ...
          placeholder="Number of times given blood"
          component={renderField}
          validate={[number]}
        />
        <Field
              ...
              <View>
                <ListItem>
                  ...
                  <Text>
                    ...
                    <Text
                      style={txtBlue}
                      onPress={() => this.refs.termsModal.open()}>
                      this terms and conditions
                    </Text>
                  </Text>
                </ListItem>
                {props.meta.error && (
                  <Text style={[txtDanger, mb, mlLg]}>{props.meta.error}</Text>
                )}
              </View>
            );
          }}
        ...
        <TouchableOpacity
          disabled={submitting}
          onPress={
            this.state.acceptTAndC ? handleSubmit(submitUserCreate) : null
          }
          style={[
            button,
            {backgroundColor: this.state.acceptTAndC ? '#337ab7' : '#808080'},
          ]}>
        ...
        <Modal
          ...
          <Text>
            All the registered user can see your{' '}
            <Text style={txtBold}>Contact Number</Text> and{' '}
            <Text style={txtBold}>E-mail</Text>. So they can call you or send
            email for blood.
          </Text>
          <Button
            style={mt}
