...
const confirmValidators = (value, values) =>
  ...
  return (
    <View>
      <Text style={txtMedium}>
        ...
        {touched && error && error == reqMsg && (
          <Text style={txtDanger}>{error}</Text>
        )}
      </Text>
      <TextInput
      ...
      {touched &&
        ((error && error != reqMsg && <Text style={txtDanger}>{error}</Text>) ||
    ...
    return (
      <View
        ...
        <Field
          ...
          label="Number of times given blood: "
