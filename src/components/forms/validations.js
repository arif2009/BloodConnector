...
module.exports = {
    ...
    confirmValidators: (value, values) => 
        value === values.Password ? undefined : 'Confirm password doesn\'t match with password!',

    acceptTerms: value => value? undefined : 'You must accept this terms and conditions!!',

    //Warning
    over70YearsOld: value => value && value > 70 ? 'You might be too old for using this' : undefined,
    isYahooMail: value => value && /.+@yahoo\.com/.test(value) ? 'Really? You still use yahoo mail ?' : undefined
};