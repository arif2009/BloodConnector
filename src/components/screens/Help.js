...
import arifImage from '../../images/arif.jpg';
      ...
      <Container style={bgColor}>
        <Content style={mlLg}>
          <View>
            ...
            <Text>
              <Icon
                style={[txtWarning, {fontSize: 22}]}
                type="FontAwesome"
                name="bell"
              />{' '}
              Password recovery & Update information options are missing in this
              app. It will be added later version. If you need, you can do it
              ...
              <Col size={75}>
                <View style={ml}>
                  ...
                  <Text style={mbSm}>
                    ...
                    <Text
                      style={txtBlue}
                      onPress={() => Linking.openURL('http://www.duet.ac.bd')}>
                      DUET
                    </Text>
                  </Text>
                  <Text
                    style={[txtBlue, mbSm]}
                    onPress={() =>
                      Communications.phonecall('+8801721654450', true)
                    }>
                    +8801721654450
                  </Text>
                  <Text
                    ...
                    onPress={() =>
                      Communications.email(
                        ...
                        null,
                        null,
                        'Bloodconnector: Issue or Openion',
                        null,
                      )
                    }>
                    arif.rahman2009@gmail.com
            ...
            <Grid style={msm}>
              <Col>
                ...
                <Text style={[txtBold, {marginBottom: 4}]}>
                  (TV News Anchor/Reporter at Ekattor)
                </Text>
                <Text
                  style={txtBlue}
                  onPress={() =>
